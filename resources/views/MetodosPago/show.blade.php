            ...
            <table class="table table-condensed table-striped table-bordered">
                ...
                @foreach($payments as $payment)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-primary btn-xs" href="{{ route('MetodosPago.edit',['id' => $payment->id] )}}" >Editar</a>
                            <a class="btn btn-outline-danger btn-xs" href="{{ route('/MetodosPago/delete',['id' => $payment->id] )}}" >Eliminar</a>
                        </td>

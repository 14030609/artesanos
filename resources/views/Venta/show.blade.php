                ...
                @foreach($payments as $payment)
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-outline-danger btn-xs" href="{{ route('/Venta/insertar',['id' => $payment->id_Venta] )}}" >AgregarProducto</a>
                            <a class="btn btn-outline-danger btn-xs" href="{{ route('/Venta/mostrar',['id' => $payment->id_Venta] )}}" >Mostrar</a>
